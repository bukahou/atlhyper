...
export const MODULE_REGISTRY: ModuleDataSource[] = [
  ...
  { key: "slo", category: "observe", labelKey: "slo", hasMock: false, defaultMode: "api" },
  // Cluster
  { key: "pod", category: "cluster", labelKey: "pod", hasMock: false, defaultMode: "api" },
  { key: "node", category: "cluster", labelKey: "node", hasMock: false, defaultMode: "api" },
  { key: "deployment", category: "cluster", labelKey: "deployment", hasMock: false, defaultMode: "api" },
  { key: "service", category: "cluster", labelKey: "service", hasMock: false, defaultMode: "api" },
  { key: "namespace", category: "cluster", labelKey: "namespace", hasMock: false, defaultMode: "api" },
  { key: "ingress", category: "cluster", labelKey: "ingress", hasMock: false, defaultMode: "api" },
  { key: "event", category: "cluster", labelKey: "event", hasMock: false, defaultMode: "api" },
  { key: "daemonset", category: "cluster", labelKey: "daemonset", hasMock: false, defaultMode: "api" },
  { key: "statefulset", category: "cluster", labelKey: "statefulset", hasMock: false, defaultMode: "api" },
  { key: "job", category: "cluster", labelKey: "job", hasMock: false, defaultMode: "api" },
  { key: "cronjob", category: "cluster", labelKey: "cronjob", hasMock: false, defaultMode: "api" },
  { key: "pv", category: "cluster", labelKey: "pv", hasMock: false, defaultMode: "api" },
  { key: "pvc", category: "cluster", labelKey: "pvc", hasMock: false, defaultMode: "api" },
  { key: "netpol", category: "cluster", labelKey: "networkPolicy", hasMock: false, defaultMode: "api" },
  { key: "quota", category: "cluster", labelKey: "resourceQuota", hasMock: false, defaultMode: "api" },
  { key: "limit", category: "cluster", labelKey: "limitRange", hasMock: false, defaultMode: "api" },
  { key: "sa", category: "cluster", labelKey: "serviceAccount", hasMock: false, defaultMode: "api" },
  // Admin
