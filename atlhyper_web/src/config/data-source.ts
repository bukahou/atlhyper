...
export const MODULE_REGISTRY: ModuleDataSource[] = [
  // Observe
  { key: "metrics", category: "observe", labelKey: "metrics", hasMock: true, defaultMode: "api" },
...
{ key: "overview", category: "observe", labelKey: "overview", hasMock: true, defaultMode: "api" },
  ...
  { key: "deployment", category: "cluster", labelKey: "deployment", hasMock: true, defaultMode: "api" },
  { key: "service", category: "cluster", labelKey: "service", hasMock: true, defaultMode: "api" },
  { key: "namespace", category: "cluster", labelKey: "namespace", hasMock: true, defaultMode: "api" },
  { key: "ingress", category: "cluster", labelKey: "ingress", hasMock: true, defaultMode: "api" },
  { key: "event", category: "cluster", labelKey: "event", hasMock: true, defaultMode: "api" },
  { key: "daemonset", category: "cluster", labelKey: "daemonset", hasMock: true, defaultMode: "api" },
  { key: "statefulset", category: "cluster", labelKey: "statefulset", hasMock: true, defaultMode: "api" },
  { key: "job", category: "cluster", labelKey: "job", hasMock: true, defaultMode: "api" },
  { key: "cronjob", category: "cluster", labelKey: "cronjob", hasMock: true, defaultMode: "api" },
  { key: "pv", category: "cluster", labelKey: "pv", hasMock: true, defaultMode: "api" },
  { key: "pvc", category: "cluster", labelKey: "pvc", hasMock: true, defaultMode: "api" },
  { key: "netpol", category: "cluster", labelKey: "networkPolicy", hasMock: true, defaultMode: "api" },
  { key: "quota", category: "cluster", labelKey: "resourceQuota", hasMock: true, defaultMode: "api" },
  { key: "limit", category: "cluster", labelKey: "limitRange", hasMock: true, defaultMode: "api" },
  { key: "sa", category: "cluster", labelKey: "serviceAccount", hasMock: true, defaultMode: "api" },
  // Admin
