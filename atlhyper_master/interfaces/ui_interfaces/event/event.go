// interfaces/ui_interfaces/event/overview.go
package event
...
func BuildEventOverview(clusterID string, withinDays int) (*EventOverviewDTO, error) {
	...
	return &EventOverviewDTO{Cards: cards, Rows: rows}, nil
}
