...
// BuildOverview 聚合总入口
func BuildOverview(ctx context.Context, clusterID string) (*ui.OverviewDTO, error) {
	// 时间窗口
	until := time.Now().UTC()
