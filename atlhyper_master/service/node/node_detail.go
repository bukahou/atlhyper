...
func GetNodeDetail(ctx context.Context, clusterID, nodeName string) (*ui.NodeDetailDTO, error) {
...
func fromModelToDetail(n mod.Node) ui.NodeDetailDTO {
	dto := ui.NodeDetailDTO{
		// summary
		Name:        n.Summary.Name,
	...
	for _, c := range n.Conditions {
		dto.Conditions = append(dto.Conditions, ui.NodeCondDTO{
			Type:      c.Type,
			Status:    c.Status,
			Reason:    c.Reason,
			Message:   c.Message,
	...
	for _, t := range n.Taints {
		dto.Taints = append(dto.Taints, ui.NodeTaintDTO{
