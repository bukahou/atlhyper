...
func (h *DeploymentHandler) List(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		handler.WriteError(w, http.StatusInternalServerError, "查询 Deployment 失败")
		return
	}
...
func (h *DeploymentHandler) Get(w http.ResponseWriter, r *http.Request) {
	...
	if name == "" {
		handler.WriteError(w, http.StatusBadRequest, "deployment name is required")
		return
	}
	...
	handler.WriteError(w, http.StatusNotFound, "Deployment not found")
}
