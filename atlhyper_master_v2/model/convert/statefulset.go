...
// cluster.StatefulSet → model.StatefulSetDetail 转换函数
package convert
...
func StatefulSetItem(src *cluster.StatefulSet) model.StatefulSetItem {
...
func StatefulSetItems(src []cluster.StatefulSet) []model.StatefulSetItem {
	if src == nil {
		return []model.StatefulSetItem{}
	}
...
func StatefulSetDetail(src *cluster.StatefulSet) model.StatefulSetDetail {
