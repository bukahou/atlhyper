...
//
// policy_repository.go - 策略和配额相关仓库实现
//
// 本文件实现以下 Repository 接口：
...
func NewResourceQuotaRepository(client sdk.K8sClient) ResourceQuotaRepository {
...
func NewLimitRangeRepository(client sdk.K8sClient) LimitRangeRepository {
...
func NewNetworkPolicyRepository(client sdk.K8sClient) NetworkPolicyRepository {
...
func NewServiceAccountRepository(client sdk.K8sClient) ServiceAccountRepository {
