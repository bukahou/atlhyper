...
//
// generic_repository.go - 通用操作仓库实现
//
// 本文件实现 GenericRepository 接口，集中处理所有写操作。
//
// 职责:
//   - 删除操作: DeletePod, Delete
//   - Deployment 操作: ScaleDeployment, RestartDeployment, UpdateDeploymentImage
//   - Node 操作: CordonNode, UncordonNode
//   - 动态查询: Execute (仅 GET)
package repository
...
func NewGenericRepository(client sdk.K8sClient) GenericRepository {
