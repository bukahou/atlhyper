  ...
  >
    ...
    <div class="summary-bar">
      ...
      <div class="right">
        ...
        <el-button size="mini" icon="el-icon-refresh" @click="fetchLogs"
          >刷新</el-button
        >
      </div>
    </div>
      ...
      <div class="content">
        <div class="log-toolbar">
          <el-input
            ...
            style="width: 240px"
          />
          <el-button size="mini" icon="el-icon-document-copy" @click="copyLogs"
            >复制</el-button
          >
          <el-button size="mini" icon="el-icon-download" @click="downloadLogs"
            >下载</el-button
          >
        </div>
